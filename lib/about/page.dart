...
class AboutPage extends StatelessWidget {
  ...
  String aboutContent(String version) => """
    <h1>About</h1>
    <p>This is an independent and free translation of the Apostle Paul's letter to the Galatians. It was translated from Latin using the text of the New Vulgate.</p>
    <p>It requires no registration or Internet connection. No information is collected, and it contains no advertising.</p>
    <p>Version: $version</p>
